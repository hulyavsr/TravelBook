...
//  TravelBook
//
//  Created by Hulya Avsar on 7.05.2022.
//
...
class ViewController: UIViewController,MKMapViewDelegate,CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if selectedTitle != ""{
            //Core data haritadan seçilem yeri göstermek için
    ...
    //kullanıcının konumunu aldığımızda neler yapacağız?
    //güncellenen locasyonları dizi içinde verecektir
